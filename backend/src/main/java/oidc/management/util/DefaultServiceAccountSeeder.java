...
public class DefaultServiceAccountSeeder {
    ...
    public void seed() {
        ...
        if (serviceAccountProperties.getRedirectUris() == null
            ...
            // Warn
            log.warning(
                    "The service account has no redirect uris. The service account will not be created.");
        ...
        if (scopes.size() != DefaultScopeSeeder.DEFAULT_SCOPES.size()) {
            ...
            // Warn
            log.warning("The number of stored scopes is not equal to the number default scopes");
        ...
        Optional<ServiceAccount> optServiceAccount =
                serviceAccountRepository.findByClientId(clientId);
        ...
        ServiceAccount serviceAccount = ServiceAccount.builder()
                ...
                .clientSecret(
                        this.passwordEncoder.encode(serviceAccountProperties.getClientSecret()))
                .clientSecretExpiresAt(null).clientName("Default Service Account")
                ...
                .authorizationGrantTypes(Arrays
                        ...
                        .stream().collect(Collectors.toSet()))
                .redirectUris(serviceAccountProperties.getRedirectUris()).scopes(
                        // TODO: Persist scopes
                        Arrays.asList(Scope.builder().name(OidcScopes.OPENID).build()).stream()
                                .collect(Collectors.toSet()))
                .clientSettings(ClientSettings.builder().requireAuthorizationConsent(true).build())
                .tokenSettings(TokenSettings.builder().build()).authorities(
        ...
        // Log
        log.info("Created a default service account with id \"" + serviceAccount.getClientId()
                + "\" and password \"" + serviceAccountProperties.getClientSecret() + "\"");
