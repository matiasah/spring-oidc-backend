...
@Document(indexName = "service_accounts")
@AllArgsConstructor
@NoArgsConstructor
@Data
@EqualsAndHashCode(of = "id")
@ValidServiceAccount
public class ElasticsearchServiceAccount implements ServiceAccount<ElasticsearchScope, ElasticsearchAuthority> {
    ...
    private Set<ElasticsearchScope> scopes;
     ...
     */
    public static class ElasticsearchServiceAccountBuilder implements ServiceAccountBuilder<ElasticsearchScope, ElasticsearchAuthority> {
