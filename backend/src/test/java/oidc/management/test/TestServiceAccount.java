...
@ValidServiceAccount
public class TestServiceAccount implements ServiceAccount<TestScope, TestAuthority> {
     ...
     */
    public static class TestServiceAccountBuilder implements ServiceAccount.ServiceAccountBuilder<TestScope, TestAuthority> {
